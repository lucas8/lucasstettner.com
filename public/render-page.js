(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("/Users/lucasstettner/Desktop/personal/lucasstettner.com/node_modules/lodash/merge.js"), require("react"), require("react-dom/server"));
	else if(typeof define === 'function' && define.amd)
		define("lib", ["/Users/lucasstettner/Desktop/personal/lucasstettner.com/node_modules/lodash/merge.js", "react", "react-dom/server"], factory);
	else if(typeof exports === 'object')
		exports["lib"] = factory(require("/Users/lucasstettner/Desktop/personal/lucasstettner.com/node_modules/lodash/merge.js"), require("react"), require("react-dom/server"));
	else
		root["lib"] = factory(root["/Users/lucasstettner/Desktop/personal/lucasstettner.com/node_modules/lodash/merge.js"], root["react"], root["react-dom/server"]);
...
var plugins = [{
  ...
  plugin: __webpack_require__(/*! ./node_modules/gatsby-plugin-fathom/gatsby-ssr */ "./node_modules/gatsby-plugin-fathom/gatsby-ssr.js"),
  options: {
    "plugins": [],
    "siteId": "LGLTYWMS"
  }
...
/***/ "./node_modules/gatsby-plugin-fathom/gatsby-ssr.js":
/*!*********************************************************!*\
  !*** ./node_modules/gatsby-plugin-fathom/gatsby-ssr.js ***!
  \*********************************************************/
/*! no static exports found */
...
var _utils = __webpack_require__(/*! ./utils */ "./node_modules/gatsby-plugin-fathom/utils.js");
...
function getTrackingCode(pluginOptions) {
  var _pluginOptions$embedV = pluginOptions.embedVersion,
      embedVersion = _pluginOptions$embedV === void 0 ? 'v1' : _pluginOptions$embedV,
      _pluginOptions$tracki = pluginOptions.trackingUrl,
      trackingUrl = _pluginOptions$tracki === void 0 ? 'cdn.usefathom.com' : _pluginOptions$tracki,
      siteId = pluginOptions.siteId;

  if (embedVersion === 'v2') {
    return /*#__PURE__*/_react["default"].createElement("script", {
      key: "gatsby-plugin-fathom",
      src: "https://".concat(trackingUrl, "/script.js"),
      site: siteId,
      defer: true
    });
  }

  var html = (0, _utils.createTrackingSnippet)(pluginOptions);
  return /*#__PURE__*/_react["default"].createElement("script", {
    key: "gatsby-plugin-fathom",
    dangerouslySetInnerHTML: {
      __html: html
...
/***/ "./node_modules/gatsby-plugin-fathom/utils.js":
/*!****************************************************!*\
  !*** ./node_modules/gatsby-plugin-fathom/utils.js ***!
  \****************************************************/
/*! no static exports found */
...
var DEFAULT_TRACKING_URL = 'cdn.usefathom.com';

exports.createTrackingSnippet = function createTrackingSnippet(_ref) {
  var _ref$trackingUrl = _ref.trackingUrl,
      trackingUrl = _ref$trackingUrl === void 0 ? DEFAULT_TRACKING_URL : _ref$trackingUrl,
      siteId = _ref.siteId;

  if (trackingUrl === DEFAULT_TRACKING_URL && !siteId) {
    throw new Error('`siteId` must be provided when using the hosted version of Fathom');
  }

  return "\n    (function(f, a, t, h, o, m){\n      a[h]=a[h]||function(){\n        (a[h].q=a[h].q||[]).push(arguments)\n      };\n      o=f.createElement('script'),\n      m=f.getElementsByTagName('script')[0];\n      o.async=1; o.src=t; o.id='fathom-script';\n      m.parentNode.insertBefore(o,m)\n    })(document, window, '//".concat(trackingUrl, "/tracker.js', 'fathom');\n    ").concat(siteId && "fathom('set', 'siteId', '" + siteId + "');", "\n  ");
};
...
/***/ "lodash/merge":
/*!*******************************************************************************************************!*\
  !*** external "/Users/lucasstettner/Desktop/personal/lucasstettner.com/node_modules/lodash/merge.js" ***!
  \*******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
